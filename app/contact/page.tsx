        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12">
            ...
            <div className="lg:col-span-5 space-y-6">
              ...
              <div className="rounded-xl bg-[#F8FAFC] p-6 sm:p-8 border border-slate-200 shadow-xs space-y-6">
                <h2 className="text-lg sm:text-xl font-extrabold text-slate-900 border-b border-slate-200 pb-3">
                  Direct Contact &amp; Location
                </h2>

                <div className="space-y-5 text-xs sm:text-sm text-slate-700">
                  <div className="flex items-start gap-3.5">
                    <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-white text-[#DC2626] shrink-0 border border-slate-200 shadow-xs">
                      <MapPin className="h-5 w-5" />
                    </div>
                    <div className="space-y-1">
                      <span className="font-bold text-slate-900 block">Locations &amp; Hubs:</span>
                      <p className="text-slate-800 font-semibold">
                        📍 <strong>Kisumu Main HQ:</strong> Kisumu Kakamega Road, Kisumu, Kenya
                      </p>
                      <p className="text-slate-600 font-medium">
                        📍 <strong>Nairobi Hub:</strong> Nairobi Region, Kenya (Rapid Field Dispatch)
                      </p>
                    </div>
                  </div>

                  <div className="flex items-start gap-3.5">
                    <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-white text-[#0F2942] shrink-0 border border-slate-200 shadow-xs">
                      <Phone className="h-5 w-5" />
                    </div>
                    <div>
                      <span className="font-bold text-slate-900 block">Phone Helplines:</span>
                      <a href={`tel:${SITE_CONFIG.telephone}`} className="text-[#0F2942] font-mono font-bold hover:underline">
                        {SITE_CONFIG.telephone}
                      </a> / <a href={`tel:${SITE_CONFIG.altTelephone}`} className="text-[#0F2942] font-mono font-bold hover:underline">
                  ...
                  <div className="flex items-start gap-3.5">
                    <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-white text-emerald-600 shrink-0 border border-slate-200 shadow-xs">
                  ...
                  <div className="flex items-start gap-3.5">
                    ...
                    <div>
                      ...
                      <a href={`mailto:${SITE_CONFIG.email}`} className="text-[#0F2942] font-semibold hover:underline">
                        {SITE_CONFIG.email}
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3.5 pt-2 border-t border-slate-200">
                    <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-white text-slate-700 shrink-0 border border-slate-200 shadow-xs">
              ...
              {/* Emergency Support Card - Solid Navy */}
              <div className="rounded-xl bg-[#0F2942] border border-[#1E3A5F] p-6 sm:p-8 text-white space-y-4 shadow-xs">
                <h3 className="text-lg font-extrabold text-white">Need Urgent Field Technical Support?</h3>
                ...
                <div className="flex flex-col gap-2.5 pt-2">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center justify-center gap-2 rounded-lg bg-emerald-600 hover:bg-emerald-700 active:bg-emerald-800 py-3 text-xs font-bold text-white transition-colors shadow-xs min-h-[44px]"
                  >
                  ...
                  <a
                    ...
                    className="flex items-center justify-center gap-2 rounded-lg border border-[#2B4C74] bg-[#1E3A5F] hover:bg-[#2B4C74] py-3 text-xs font-bold text-white transition-colors shadow-xs min-h-[44px]"
                  >
            ...
            <div className="lg:col-span-7 space-y-8">
              ...
              <div className="rounded-xl bg-[#F8FAFC] p-6 border border-slate-200 shadow-xs space-y-4">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center justify-center gap-1.5 rounded-lg bg-white px-3.5 py-2 text-xs font-bold text-[#0F2942] hover:bg-slate-50 transition-colors border border-slate-300 w-fit min-h-[38px]"
                  >
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pt-1 text-xs text-slate-600 font-medium">
                  ...
                  <p className="text-slate-500 font-mono">Coordinates: -0.0917° S, 34.7680° E</p>
                </div>
              </div>
