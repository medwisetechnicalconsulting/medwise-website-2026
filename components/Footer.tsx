          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            <div className="space-y-2 pt-1">
              ...
              <div className="flex items-center gap-3">
                ...
                {/* Official Facebook */}
                <a
                  href="https://facebook.com/medwisetechnicalconsulting"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Official Facebook"
                  className="flex h-9 w-9 items-center justify-center rounded-xl bg-blue-600 text-white shadow-2xs hover:bg-blue-700 hover:scale-105 transition-all"
                >
                  <svg className="h-4 w-4 fill-white" viewBox="0 0 24 24">
                ...
                {/* Official Instagram */}
                <a
                  href="https://instagram.com/medwisetechnicalconsulting"
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                {/* Official LinkedIn */}
                <a
                  href="https://linkedin.com/company/medwise-technical-consulting"
                  target="_blank"
                  rel="noopener noreferrer"
                  aria-label="Official LinkedIn"
                  className="flex h-9 w-9 items-center justify-center rounded-xl bg-blue-800 text-white shadow-2xs hover:bg-blue-900 hover:scale-105 transition-all"
                >
                  <svg className="h-4 w-4 fill-white" viewBox="0 0 24 24">
