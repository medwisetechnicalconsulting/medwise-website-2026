...
export default function ContactForm() {
  return (
    <div className="rounded-xl bg-white p-8 sm:p-10 border border-slate-200 shadow-xs space-y-6">
      <div>
        <h2 className="text-2xl font-extrabold text-slate-900">Request a Technical Consultation</h2>
      ...
      <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
        ...
        <a
          ...
          className="flex w-full items-center justify-center gap-2 rounded-lg bg-blue-700 py-3.5 text-xs font-bold text-white shadow-xs hover:bg-blue-800 transition-colors"
        >
