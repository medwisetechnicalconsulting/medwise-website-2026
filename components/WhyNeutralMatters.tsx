    ...
    <section className="py-16 sm:py-24 bg-white border-b border-slate-200 overflow-hidden">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          className="rounded-3xl bg-slate-50 p-8 sm:p-12 border border-slate-200 shadow-sm relative overflow-hidden"
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            {/* Right Comparison Box - Clean Interactive Light Card */}
            <motion.div
              whileHover={{ scale: 1.02 }}
              className="lg:col-span-5 rounded-3xl bg-white p-6 border border-slate-200 text-slate-900 space-y-4 shadow-lg transition-transform"
            >
              <h3 className="text-base font-bold text-slate-900 flex items-center justify-between border-b border-slate-100 pb-3">
                ...
                <span className="text-xs text-blue-700 font-bold bg-blue-50 px-2.5 py-0.5 rounded-full border border-blue-100">Comparison</span>
              </h3>
              ...
              <div className="space-y-3 text-xs">
                ...
                <div className="p-3 rounded-2xl bg-slate-50 border border-slate-200 space-y-1">
                  ...
                  <p className="text-slate-600 font-medium">Pushes single portfolio regardless of suitability or budget limits.</p>
                </div>

                {/* Point 2 */}
                <div className="p-3 rounded-2xl bg-blue-50/90 border border-blue-200 space-y-1 shadow-2xs">
                  <div className="flex items-center justify-between font-bold text-blue-900">
                    <span>Medwise Independent Advisory</span>
                    <Check className="h-4 w-4 text-blue-700 stroke-[3]" />
                  </div>
                  <p className="text-slate-700 font-medium">Evaluates multi-brand options based on total cost & clinical workflow.</p>
                </div>
                ...
                <div className="p-3 rounded-2xl bg-slate-50 border border-slate-200 space-y-1">
                  ...
                  <p className="text-slate-600 font-medium">Locks facility into proprietary expensive consumables & repair contracts.</p>
                </div>
              </div>
            </motion.div>
