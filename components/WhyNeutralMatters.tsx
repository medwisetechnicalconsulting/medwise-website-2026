  ...
  return (
    <section className="py-16 sm:py-20 bg-white border-b border-slate-200">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="rounded-xl bg-[#F8FAFC] p-6 sm:p-10 border border-slate-200">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
            ...
            <div className="lg:col-span-7 space-y-4">
              <div className="inline-flex items-center gap-2 rounded-md bg-white px-3 py-1 text-xs font-bold text-[#0F2942] border border-slate-200 shadow-xs">
                <Scale className="h-3.5 w-3.5 text-[#DC2626]" />
            ...
            <div className="lg:col-span-5 rounded-xl bg-white p-5 sm:p-6 border border-slate-200 text-slate-900 space-y-3.5 shadow-xs">
              <div className="flex items-center justify-between border-b border-slate-200 pb-3">
                ...
                <span className="text-[10px] font-bold uppercase tracking-wider text-[#0F2942] bg-slate-100 px-2.5 py-0.5 rounded border border-slate-200">
                  Comparison Matrix
                </span>
              </div>
